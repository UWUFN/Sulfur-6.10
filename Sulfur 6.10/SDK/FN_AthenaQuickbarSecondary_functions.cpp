...
// Parameters:
// bool                           bNativeMode                    (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UAthenaQuickbarSecondary_C::SetQuickBarNativeMode(bool bNativeMode)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaQuickbarSecondary.AthenaQuickbarSecondary_C.SetQuickBarNativeMode");

	UAthenaQuickbarSecondary_C_SetQuickBarNativeMode_Params params;
	params.bNativeMode = bNativeMode;
