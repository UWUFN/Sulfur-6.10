...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaQuickbarPrimary.AthenaQuickbarPrimary_C.SetQuickBarNativeMode");

	UAthenaQuickbarPrimary_C_SetQuickBarNativeMode_Params params;
