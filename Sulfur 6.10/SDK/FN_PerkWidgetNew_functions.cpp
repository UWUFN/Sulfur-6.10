...
void UPerkWidgetNew_C::SetDescriptionWrapTextAt(float WrapTextAt)
{
	static auto fn = UObject::FindObject<UFunction>("Function PerkWidgetNew.PerkWidgetNew_C.SetDescriptionWrapTextAt");

	UPerkWidgetNew_C_SetDescriptionWrapTextAt_Params params;
...
void UPerkWidgetNew_C::InitializeSettings(bool bIncludeName, bool bIncludeDescription, TEnumAsByte<EFortBrushSize> IconSize, bool bUseLargeFormatName, const struct FFortUIPerk& Perk, bool ShowMouseTooltips, float WrapTextAt)
{
