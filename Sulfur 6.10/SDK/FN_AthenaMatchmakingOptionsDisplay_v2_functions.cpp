...
// bool*                          bPartyTooSmall                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// bool*                          bPartyTooBig                   (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
// bool*                          bIsTournamentPlaylist          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
void UAthenaMatchmakingOptionsDisplay_v2_C::UpdateMatchmakingButtonsBP(bool* IsPartyLeader, bool* IsMatchmaking, bool* bPartyTooSmall, bool* bPartyTooBig, bool* PlaylistIsDisabled, bool* CanShowFill, bool* bIsTournamentPlaylist)
{
	...
	params.bPartyTooSmall = bPartyTooSmall;
	params.bPartyTooBig = bPartyTooBig;
	params.PlaylistIsDisabled = PlaylistIsDisabled;
	params.CanShowFill = CanShowFill;
	params.bIsTournamentPlaylist = bIsTournamentPlaylist;
