...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_Prj_Ranged_GrenadeLauncher_Athena.B_Prj_Ranged_GrenadeLauncher_Athena_C.ReceiveDestroyed");

	AB_Prj_Ranged_GrenadeLauncher_Athena_C_ReceiveDestroyed_Params params;
