...
void UMissionFocusWidget_C::Update_Countdown_Music()
{
	static auto fn = UObject::FindObject<UFunction>("Function MissionFocusWidget.MissionFocusWidget_C.Update Countdown Music");

	UMissionFocusWidget_C_Update_Countdown_Music_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function MissionFocusWidget.MissionFocusWidget_C.UpdateAutoRefreshTimer");

	UMissionFocusWidget_C_UpdateAutoRefreshTimer_Params params;
