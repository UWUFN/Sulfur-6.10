...
struct UTimeSynthComponent_SetFilterSettings_Params
{
	...
	struct FTimeSynthFilterSettings                    InSettings;                                               // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};
...
{
	struct FTimeSynthEnvelopeFollowerSettings          InSettings;                                               // (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData)
};
