...
void UGamepadKeyTextButton_C::SetData(const struct FKey& Key, const struct FText& DescText, const struct FName& ActionName)
{
...
void UGamepadKeyTextButton_C::SetDataAndUpdateButton(const struct FKey& Key, const struct FText& DescText, const struct FName& ActionName)
{
...
void UGamepadKeyTextButton_C::ChangeTheBinding_Button__DelegateSignature(const struct FName& ActionName, const struct FKey& Key)
{
