...
void UItemManagementMulchModeBox_C::SetScrollFocus()
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemManagementMulchModeBox.ItemManagementMulchModeBox_C.SetScrollFocus");

	UItemManagementMulchModeBox_C_SetScrollFocus_Params params;
