...
// struct FVector                 HitVelocity                    (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData)
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysicsBall_Master.PhysicsBall_Master_C.ReplicateKick");

	APhysicsBall_Master_C_ReplicateKick_Params params;
	params.HitLocation = HitLocation;
	params.HitVelocity = HitVelocity;
	params.HitActor = HitActor;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function PhysicsBall_Master.PhysicsBall_Master_C.BndEvt__SphereCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");

	APhysicsBall_Master_C_BndEvt__SphereCollision_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params params;
