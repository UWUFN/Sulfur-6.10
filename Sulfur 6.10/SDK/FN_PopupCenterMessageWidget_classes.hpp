...
public:
	...
	class UPopupCenterMessageModalPanel_C*             CenterPopupModal;                                         // 0x0260(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	struct FTimerHandle                                UpdateStateTimer;                                         // 0x0268(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
