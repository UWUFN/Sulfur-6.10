...
public:
	...
	unsigned char                                      UnknownData01[0x338];                                     // 0x00B8(0x0338) MISSED OFFSET
...
{
public:
	class UReplicationGraphNode_ActorList*             AlwaysRelevantNode;                                       // 0x03F0(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FConnectionAlwaysRelevantNodePair>   AlwaysRelevantForConnectionList;                          // 0x03F8(0x0010) (ZeroConstructor)
	TArray<class AActor*>                              ActorsWithoutNetConnection;                               // 0x0408(0x0010) (ZeroConstructor)
