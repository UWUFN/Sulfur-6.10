...
// Parameters:
// bool                           ShouldAutoRefresh              (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UDefaultObjectiveContentWidget_C::UpdateAutoRefreshTimer(bool ShouldAutoRefresh)
{
	static auto fn = UObject::FindObject<UFunction>("Function DefaultObjectiveContentWidget.DefaultObjectiveContentWidget_C.UpdateAutoRefreshTimer");

	UDefaultObjectiveContentWidget_C_UpdateAutoRefreshTimer_Params params;
	params.ShouldAutoRefresh = ShouldAutoRefresh;
