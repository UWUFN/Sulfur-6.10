...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaEquipProgress.AthenaEquipProgress_C.VerifyCueCountIsClear");

	UAthenaEquipProgress_C_VerifyCueCountIsClear_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaEquipProgress.AthenaEquipProgress_C.HideSelf");

	UAthenaEquipProgress_C_HideSelf_Params params;
