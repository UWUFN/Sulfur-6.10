...
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaQuickBarSlot.AthenaQuickBarSlot_C.Construct");

	UAthenaQuickBarSlot_C_Construct_Params params;
...
void UAthenaQuickBarSlot_C::Handle_OnQuickbarContentsChanged(EFortQuickBars QuickbarIndex, TArray<int> ChangedSlots)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaQuickBarSlot.AthenaQuickBarSlot_C.Handle OnQuickbarContentsChanged");

	UAthenaQuickBarSlot_C_Handle_OnQuickbarContentsChanged_Params params;
