...
// Parameters:
// EFortItemCardSize              NewParam                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UAthenaCustomizationSlotButton_C::SetCardSize(EFortItemCardSize NewParam)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaCustomizationSlotButton.AthenaCustomizationSlotButton_C.SetCardSize");

	UAthenaCustomizationSlotButton_C_SetCardSize_Params params;
