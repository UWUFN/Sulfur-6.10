...
// Parameters:
// struct FFortHUDState           Current_Hud_State              (BlueprintVisible, BlueprintReadOnly, Parm)
// bool                           ShouldHide                     (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UButton_Crouch_C::ShouldHide(const struct FFortHUDState& Current_Hud_State, bool* ShouldHide)
{
	static auto fn = UObject::FindObject<UFunction>("Function Button_Crouch.Button_Crouch_C.ShouldHide");

	UButton_Crouch_C_ShouldHide_Params params;
	params.Current_Hud_State = Current_Hud_State;
