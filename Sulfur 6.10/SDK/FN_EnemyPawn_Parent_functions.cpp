...
void AEnemyPawn_Parent_C::RegisterBuildingHitStaticMesh(class UStaticMeshComponent* Mesh)
{
	static auto fn = UObject::FindObject<UFunction>("Function EnemyPawn_Parent.EnemyPawn_Parent_C.RegisterBuildingHitStaticMesh");

	AEnemyPawn_Parent_C_RegisterBuildingHitStaticMesh_Params params;
	params.Mesh = Mesh;
...
void AEnemyPawn_Parent_C::RegisterBuildingHitSkeletalMesh(class USkeletalMeshComponent* Mesh)
{
	static auto fn = UObject::FindObject<UFunction>("Function EnemyPawn_Parent.EnemyPawn_Parent_C.RegisterBuildingHitSkeletalMesh");

	AEnemyPawn_Parent_C_RegisterBuildingHitSkeletalMesh_Params params;
	params.Mesh = Mesh;
...
// Parameters:
// class UStaticMeshComponent*    Mesh                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
// class UStaticMeshComponent*    EffectMesh                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void AEnemyPawn_Parent_C::ApplyBuildingHitEffectToStaticMesh(class UStaticMeshComponent* Mesh, class UStaticMeshComponent* EffectMesh)
{
...
// Parameters:
// class USkeletalMeshComponent*  Mesh                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)
// class USkeletalMeshComponent*  EffectMesh                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void AEnemyPawn_Parent_C::ApplyBuildingHitEffectToSkeletalMesh(class USkeletalMeshComponent* Mesh, class USkeletalMeshComponent* EffectMesh)
{
