...
// (Event, Protected, BlueprintEvent)
// Parameters:
// bool*                          bShouldDoQuickBarNative        (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UAthenaHUD_C::SetQuickBarNative(bool* bShouldDoQuickBarNative)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaHUD.AthenaHUD_C.SetQuickBarNative");

	UAthenaHUD_C_SetQuickBarNative_Params params;
	params.bShouldDoQuickBarNative = bShouldDoQuickBarNative;
