...
void UGamepadCustomActionSelectorPanel_v3_C::CreateCustomListItem(const struct FName& ActionName, EFortInputActionGroup InputActionGroup, class UGamepadKeyTextButton_C** ReturnItem)
{
...
{
	static auto fn = UObject::FindObject<UFunction>("Function GamepadCustomActionSelectorPanel_v3.GamepadCustomActionSelectorPanel_v3_C.BndEvt__Button_Clear_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature");

	UGamepadCustomActionSelectorPanel_v3_C_BndEvt__Button_Clear_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params params;
...
void UGamepadCustomActionSelectorPanel_v3_C::CustomActionSelected__DelegateSignature(int SelectedIndex, const struct FName& ActionName)
{
