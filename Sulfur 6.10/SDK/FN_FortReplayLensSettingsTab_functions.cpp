...
void UFortReplayLensSettingsTab_C::RefreshHighQualityFXState(const struct FFortReplayFXState& FX_State)
{
	static auto fn = UObject::FindObject<UFunction>("Function FortReplayLensSettingsTab.FortReplayLensSettingsTab_C.RefreshHighQualityFXState");

	UFortReplayLensSettingsTab_C_RefreshHighQualityFXState_Params params;
...
void UFortReplayLensSettingsTab_C::BndEvt__HighQualityFX_K2Node_ComponentBoundEvent_0_Selection_Changed__DelegateSignature(int Selected_Index)
{
	static auto fn = UObject::FindObject<UFunction>("Function FortReplayLensSettingsTab.FortReplayLensSettingsTab_C.BndEvt__HighQualityFX_K2Node_ComponentBoundEvent_0_Selection Changed__DelegateSignature");

	UFortReplayLensSettingsTab_C_BndEvt__HighQualityFX_K2Node_ComponentBoundEvent_0_Selection_Changed__DelegateSignature_Params params;
	params.Selected_Index = Selected_Index;
