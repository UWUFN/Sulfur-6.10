...
void UItemManagementScreen_C::HandleDifferentModeSet()
{
	static auto fn = UObject::FindObject<UFunction>("Function ItemManagementScreen.ItemManagementScreen_C.HandleDifferentModeSet");

	UItemManagementScreen_C_HandleDifferentModeSet_Params params;
