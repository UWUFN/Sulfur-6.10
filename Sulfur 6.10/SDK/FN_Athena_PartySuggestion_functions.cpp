...
// Parameters:
// bool                           Opened                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UAthena_PartySuggestion_C::OnRadialPickerStatusChanged(bool Opened)
{
	static auto fn = UObject::FindObject<UFunction>("Function Athena_PartySuggestion.Athena_PartySuggestion_C.OnRadialPickerStatusChanged");

	UAthena_PartySuggestion_C_OnRadialPickerStatusChanged_Params params;
