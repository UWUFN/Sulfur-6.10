...
public:
	...
	class UFortOptionsMenuSetting*                     DisplayResolutionSetting;                                 // 0x02A0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	TMap<ESettingType, class UFortOptionsMenuSetting*> ForceUpdateSettings;                                      // 0x02A8(0x0050) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance)
