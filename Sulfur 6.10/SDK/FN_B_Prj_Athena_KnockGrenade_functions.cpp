...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_Prj_Athena_KnockGrenade.B_Prj_Athena_KnockGrenade_C.OnTouched");

	AB_Prj_Athena_KnockGrenade_C_OnTouched_Params params;
	params.OtherActor = OtherActor;
	params.OtherComp = OtherComp;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function B_Prj_Athena_KnockGrenade.B_Prj_Athena_KnockGrenade_C.BndEvt__ProjectileMovementComponent_K2Node_ComponentBoundEvent_1_OnProjectileBounceDelegate__DelegateSignature");

	AB_Prj_Athena_KnockGrenade_C_BndEvt__ProjectileMovementComponent_K2Node_ComponentBoundEvent_1_OnProjectileBounceDelegate__DelegateSignature_Params params;
