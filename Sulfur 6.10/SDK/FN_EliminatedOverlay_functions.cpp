...
void UEliminatedOverlay_C::GetPlayerName(class AFortPlayerStateAthena* InPlayerState, struct FString* PlayerName)
{
	static auto fn = UObject::FindObject<UFunction>("Function EliminatedOverlay.EliminatedOverlay_C.GetPlayerName");

	UEliminatedOverlay_C_GetPlayerName_Params params;
...
// Parameters:
// class AFortPlayerStateAthena*  PlayerState                    (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UEliminatedOverlay_C::GetPlayerState(class AFortPlayerStateAthena** PlayerState)
{
	static auto fn = UObject::FindObject<UFunction>("Function EliminatedOverlay.EliminatedOverlay_C.GetPlayerState");

	UEliminatedOverlay_C_GetPlayerState_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function EliminatedOverlay.EliminatedOverlay_C.HideWinnerAnnouncement");

	UEliminatedOverlay_C_HideWinnerAnnouncement_Params params;
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortPlayerStateAthena*  InKillerPlayerState            (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UEliminatedOverlay_C::OnPawnDied(class AFortPlayerStateAthena* InKillerPlayerState)
{
