...
public:
	...
	float                                              PPFader_PPFade_7424DD024FE8AE2B8B68448F1966ED3C;          // 0x06E8(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    PPFader__Direction_7424DD024FE8AE2B8B68448F1966ED3C;      // 0x06EC(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_Prj_Ranged_Rocket.B_Prj_Ranged_Rocket_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_B_Prj_Ranged_Rocket(int EntryPoint);
};
