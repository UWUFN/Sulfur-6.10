...
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Athena_PlayerCameraModeTargetingLauncherMilitary.Athena_PlayerCameraModeTargetingLauncherMilitary_C");
		return ptr;
	}
