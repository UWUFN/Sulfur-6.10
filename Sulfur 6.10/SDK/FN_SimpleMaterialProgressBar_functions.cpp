...
{
	static auto fn = UObject::FindObject<UFunction>("Function SimpleMaterialProgressBar.SimpleMaterialProgressBar_C.SetColorBackground");

	USimpleMaterialProgressBar_C_SetColorBackground_Params params;
	params.Value = Value;
