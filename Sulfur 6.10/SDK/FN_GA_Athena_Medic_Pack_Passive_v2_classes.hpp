...
public:
	...
	class AFortPlayerPawnAthena*                       PlayerPawn;                                               // 0x09D0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	struct FTimerHandle                                TargetTimer;                                              // 0x09D8(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	class ABP_MedicPack_HealTarget_C*                  TargetIndicator;                                          // 0x09E0(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
	class ABP_MedicPack_HealNozzle_C*                  TargetingNozzle;                                          // 0x09E8(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, DisableEditOnInstance, IsPlainOldData)
