...
{
	static auto fn = UObject::FindObject<UFunction>("Function GCL_TNT_Fuse_Projectile.GCL_TNT_Fuse_Projectile_C.ModulateFuseSound");

	AGCL_TNT_Fuse_Projectile_C_ModulateFuseSound_Params params;
