...
struct FEventReply UPackResource_C::OnTouchEnded(struct FGeometry* MyGeometry, struct FPointerEvent* InTouchEvent)
{
	static auto fn = UObject::FindObject<UFunction>("Function PackResource.PackResource_C.OnTouchEnded");

	UPackResource_C_OnTouchEnded_Params params;
...
struct FEventReply UPackResource_C::OnTouchMoved(struct FGeometry* MyGeometry, struct FPointerEvent* InTouchEvent)
{
	static auto fn = UObject::FindObject<UFunction>("Function PackResource.PackResource_C.OnTouchMoved");

	UPackResource_C_OnTouchMoved_Params params;
	params.MyGeometry = MyGeometry;
	params.InTouchEvent = InTouchEvent;
