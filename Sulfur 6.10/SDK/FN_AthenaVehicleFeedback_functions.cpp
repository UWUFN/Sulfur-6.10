...
void UAthenaVehicleFeedback_C::GetKeybindInputType(ECommonInputType* InputType)
{
	static auto fn = UObject::FindObject<UFunction>("Function AthenaVehicleFeedback.AthenaVehicleFeedback_C.GetKeybindInputType");

	UAthenaVehicleFeedback_C_GetKeybindInputType_Params params;
