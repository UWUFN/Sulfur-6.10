...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// EPartyType                     PartyType                      (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void ABP_Hex_PARENT_C::HandlePartyTypeChanged(EPartyType PartyType)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Hex_PARENT.BP_Hex_PARENT_C.HandlePartyTypeChanged");

	ABP_Hex_PARENT_C_HandlePartyTypeChanged_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Hex_PARENT.BP_Hex_PARENT_C.HandleTeamMemberAdded");

	ABP_Hex_PARENT_C_HandleTeamMemberAdded_Params params;
...
void ABP_Hex_PARENT_C::HandleTeamMemberRemoved(int PlayerIndex)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Hex_PARENT.BP_Hex_PARENT_C.HandleTeamMemberRemoved");

	ABP_Hex_PARENT_C_HandleTeamMemberRemoved_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Hex_PARENT.BP_Hex_PARENT_C.HandlePartyChanged");

	ABP_Hex_PARENT_C_HandlePartyChanged_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Hex_PARENT.BP_Hex_PARENT_C.HandleTeamMemberPromoted");

	ABP_Hex_PARENT_C_HandleTeamMemberPromoted_Params params;
