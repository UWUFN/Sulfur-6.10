...
// Parameters:
// bool                           UseNewWidget                   (Parm, OutParm, ZeroConstructor, IsPlainOldData)
// class UResults_CommanderXP_New_C* CommanderXPNew_Widget          (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData)
// class UResults_CommanderXP_C*  CommanderXPOld_Widget          (Parm, OutParm, ZeroConstructor, InstancedReference, IsPlainOldData)

void UResults_Widget_C::GetCommanderXPWidget(bool* UseNewWidget, class UResults_CommanderXP_New_C** CommanderXPNew_Widget, class UResults_CommanderXP_C** CommanderXPOld_Widget)
{
	static auto fn = UObject::FindObject<UFunction>("Function Results_Widget.Results_Widget_C.GetCommanderXPWidget");

	UResults_Widget_C_GetCommanderXPWidget_Params params;
	...
	if (UseNewWidget != nullptr)
		*UseNewWidget = params.UseNewWidget;
	if (CommanderXPNew_Widget != nullptr)
		*CommanderXPNew_Widget = params.CommanderXPNew_Widget;
	if (CommanderXPOld_Widget != nullptr)
		*CommanderXPOld_Widget = params.CommanderXPOld_Widget;
}
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Results_Widget.Results_Widget_C.AddCommanderXPWidget");

	UResults_Widget_C_AddCommanderXPWidget_Params params;
...
{
	static auto fn = UObject::FindObject<UFunction>("Function Results_Widget.Results_Widget_C.Xp Finished");

	UResults_Widget_C_Xp_Finished_Params params;
