...
{
	static auto fn = UObject::FindObject<UFunction>("Function ChatWidget.ChatWidget_C.HandlePreShowConfirmation");

	UChatWidget_C_HandlePreShowConfirmation_Params params;
