...
public:
	...
	unsigned char                                      UnknownData04[0x50];                                      // 0x01C8(0x0050) MISSED OFFSET
...
public:
	...
	bool                                               bSimpleTextMode;                                          // 0x01FE(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x11];                                      // 0x01FF(0x0011) MISSED OFFSET
...
public:
	...
	struct FIntPoint                                   DrawSize;                                                 // 0x05A0(0x0008) (Edit, IsPlainOldData)
	...
	struct FIntPoint                                   CurrentDrawSize;                                          // 0x05B8(0x0008) (IsPlainOldData)
	...
	struct FVector2D                                   Pivot;                                                    // 0x05C4(0x0008) (Edit, IsPlainOldData)
	...
	struct FLinearColor                                BackgroundColor;                                          // 0x05D8(0x0010) (Edit, IsPlainOldData)
	struct FLinearColor                                TintColorAndOpacity;                                      // 0x05E8(0x0010) (Edit, IsPlainOldData)
	...
	bool                                               TickWhenOffscreen;                                        // 0x05FE(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x1];                                       // 0x05FF(0x0001) MISSED OFFSET
	class UUserWidget*                                 Widget;                                                   // 0x0600(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, DuplicateTransient, IsPlainOldData)
	unsigned char                                      UnknownData06[0x20];                                      // 0x0608(0x0020) MISSED OFFSET
	...
	bool                                               bAddedToScreen;                                           // 0x0670(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	bool                                               bEditTimeUsable;                                          // 0x0671(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x6];                                       // 0x0672(0x0006) MISSED OFFSET
	struct FName                                       SharedLayerName;                                          // 0x0678(0x0008) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	int                                                LayerZOrder;                                              // 0x0680(0x0004) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	EWidgetGeometryMode                                GeometryMode;                                             // 0x0684(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData08[0x3];                                       // 0x0685(0x0003) MISSED OFFSET
	float                                              CylinderArcAngle;                                         // 0x0688(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData09[0x24];                                      // 0x068C(0x0024) MISSED OFFSET
