...
public:
	...
	float                                              PPFader_PPFade_BF16B9BE4F8169C0D83DA7A4199FED10;          // 0x06F0(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    PPFader__Direction_BF16B9BE4F8169C0D83DA7A4199FED10;      // 0x06F4(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass B_Prj_Ranged_QuadRocket_Athena.B_Prj_Ranged_QuadRocket_Athena_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_B_Prj_Ranged_QuadRocket_Athena(int EntryPoint);
};
