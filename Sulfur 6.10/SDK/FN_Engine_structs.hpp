...
struct FRichCurveKey
{
	...
	float                                              LeaveTangent;                                             // 0x0010(0x0004) (ZeroConstructor, IsPlainOldData)
};
...
struct FSkeletalMeshOptimizationSettings
{
	...
	unsigned char                                      bEnforceBoneBoundaries : 1;                               // 0x001C(0x0001) (Edit)
	unsigned char                                      UnknownData01[0x3];                                       // 0x001D(0x0003) MISSED OFFSET
	float                                              VolumeImportance;                                         // 0x0020(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bLockEdges : 1;                                           // 0x0024(0x0001) (Edit)
...
struct FSkeletalMeshLODInfo
{
	...
	struct FSkeletalMeshOptimizationSettings           ReductionSettings;                                        // 0x0018(0x002C) (Edit)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0044(0x0004) MISSED OFFSET
	TArray<struct FBoneReference>                      BonesToRemove;                                            // 0x0048(0x0010) (Edit, ZeroConstructor)
	TArray<struct FBoneReference>                      BonesToPrioritize;                                        // 0x0058(0x0010) (Edit, ZeroConstructor)
	float                                              WeightOfPrioritization;                                   // 0x0068(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x006C(0x0004) MISSED OFFSET
	class UAnimSequence*                               BakePose;                                                 // 0x0070(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UAnimSequence*                               BakePoseOverride;                                         // 0x0078(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FString                                     SourceImportFilename;                                     // 0x0080(0x0010) (Edit, ZeroConstructor, EditConst)
	unsigned char                                      bHasBeenSimplified : 1;                                   // 0x0090(0x0001)
	unsigned char                                      bHasPerLODVertexColors : 1;                               // 0x0090(0x0001)
	unsigned char                                      bAllowCPUAccess : 1;                                      // 0x0090(0x0001) (Edit)
	unsigned char                                      bSupportUniformlyDistributedSampling : 1;                 // 0x0090(0x0001) (Edit)
...
struct FSkeletalMeshLODGroupSettings
{
	...
	struct FSkeletalMeshOptimizationSettings           ReductionSettings;                                        // 0x0040(0x002C) (Edit)
...
struct FAnimNode_AssetPlayerBase : public FAnimNode_Base
{
	...
	bool                                               bIgnoreForRelevancyTest;                                  // 0x0035(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x2];                                       // 0x0036(0x0002) MISSED OFFSET
	float                                              BlendWeight;                                              // 0x0038(0x0004) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
	float                                              InternalTimeAccumulator;                                  // 0x003C(0x0004) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
...
struct FAnimNode_SequencePlayer : public FAnimNode_AssetPlayerBase
{
	...
	bool                                               bLoopAnimation;                                           // 0x0058(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0059(0x0003) MISSED OFFSET
	float                                              PlayRateBasis;                                            // 0x005C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PlayRate;                                                 // 0x0060(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FInputScaleBiasClamp                        PlayRateScaleBiasClamp;                                   // 0x0064(0x0030) (Edit, BlueprintVisible)
	float                                              StartPosition;                                            // 0x0094(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FAnimNode_StateMachine : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData01[0x8C];                                      // 0x0044(0x008C) MISSED OFFSET
};
...
struct FAnimationActiveTransitionEntry
{
	...
	unsigned char                                      UnknownData01[0x30];                                      // 0x0090(0x0030) MISSED OFFSET
};
...
struct FFunctionExpressionOutput
{
	...
	struct FExpressionOutput                           Output;                                                   // 0x0018(0x0008)
};
