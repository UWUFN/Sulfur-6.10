...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x0700(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x0700(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0701(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x0704(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x1C];                                      // 0x0708(0x001C) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x0724(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ServerDesiredSocketSendBufferBytes;                       // 0x0728(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketReceiveBufferBytes;                    // 0x072C(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	uint32_t                                           ClientDesiredSocketSendBufferBytes;                       // 0x0730(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData02[0x14];                                      // 0x0734(0x0014) MISSED OFFSET
