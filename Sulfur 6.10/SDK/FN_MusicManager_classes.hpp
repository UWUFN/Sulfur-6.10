...
// 0x00B4 (0x043C - 0x0388)
class AMusicManager_C : public AFortMusicManager
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                           // 0x0388(0x0008) (Transient, DuplicateTransient)
	float                                              Gameplay_Music_Fader_Volume_9439D7624B6E99ADF50793B4628A7615;// 0x0390(0x0004) (ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ETimelineDirection>                    Gameplay_Music_Fader__Direction_9439D7624B6E99ADF50793B4628A7615;// 0x0394(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	class UFortMusicAsset*                             DeathMusic;                                               // 0x0420(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	bool                                               Countdown_Music_;                                         // 0x0428(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData06[0x7];                                       // 0x0429(0x0007) MISSED OFFSET
	class UAudioComponent*                             Coundown_Atlas_Music;                                     // 0x0430(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, InstancedReference, IsPlainOldData)
	float                                              NewVar_0_1;                                               // 0x0438(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
