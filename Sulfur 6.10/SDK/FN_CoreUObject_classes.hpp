...
public:
	...
	template<typename T>
	static T* FindObject(const std::string& name, bool bFull = true)
	{
	...
	void ProcessEvent(void* Func, void* Params)
	{
		GetVFunction<void (*)(void*, void*, void*)>(this, 64)(this, Func, Params);
	}
