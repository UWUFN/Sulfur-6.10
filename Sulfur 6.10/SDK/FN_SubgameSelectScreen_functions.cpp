...
// Parameters:
// ESubGame                       Key                            (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void USubgameSelectScreen_C::SetCMSTextureToKeyArt(ESubGame Key)
{
...
// Parameters:
// ESubGame*                      SubGame                        (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UTexture2DDynamic**      Image                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void USubgameSelectScreen_C::OnSubGameImageLoadedFromCMS(ESubGame* SubGame, class UTexture2DDynamic** Image)
{
